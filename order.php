...
if ($func=='order'){
    ...
    $items= $row[0];
    $sql=" select concat(firstname,' ', lastname) as name, street_no, concat(city, ', ', state, ', ', zipcode) as city from members where member_id = '".$_SESSION['member_id']."'";
    $result=mysqli_query($conn,$sql);
    $row = mysqli_fetch_array($result, MYSQLI_BOTH);
    $name=$row["name"];
...
?>
    ...
    <form class='normal' action='order.php?func=order' method = 'post' enctype="multipart/form-data">
        <div class = "container" style="width: 95%; min-width:700px; animation: fadeInAnimation ease 2s;">
            <div class="container" style="background-color: white; width: 60%; padding-left:20px;margin-right:0px;margin-top:0px;">
                ...
                <div class="container" style="width: 100%; background-color: white; margin-left:auto;margin-right:auto;">
                        ...
                        <div class="container_vertical" style="width: 75%; margin-top:0px;padding:10px; margin-left:0;">
                            ...
                            <div class="h15" ><?php echo $city; ?></div>
                        </div>
                </div>
                ...
                <div class="container" style="width: 100%; background-color: white; margin-left:auto;margin-right:auto;">
                        ...
                        <div class="container_vertical" style="width: 75%; margin-top:0px;padding:10px; margin-left:0;">
                            <div class="h15" style = "margin-bottom:10px;" >Paying with Visa 4071</div>
                ...
                <div class="container" style="width: 100%; background-color: white; margin-left:auto;margin-right:auto;">
                    ...
                    ?>
                        ...
                        <div class="container_cart" style="width: 95%; padding-left:20px;margin-left:auto;margin-right:auto;">
                            
                            <img src='images/<?php echo $row['product_img']?>' style="width:40%; height:auto;margin-left:20px;margin-right:auto;">
